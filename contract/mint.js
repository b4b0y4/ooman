...
function showMintData(tokenId) {
    try {
        ...
        console.log(`   svg: "${tokenData.image.substring(0, 50)}..." (${tokenData.image.length} chars)`);
        ...
        const estimatedGas = 50000 + (totalBytes * 20) + (tokenData.proof.length * 2000);
...
function showDeploymentInfo() {
    ...
    console.log(`   Network: Ethereum (or Optimism for testing)\n`);
    
    console.log('🔧 Quick Deploy (Foundry):');
